    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=5, verbose_name='Language', choices=[(b'en', b'EN'), (b'cs', b'CS')])),
                ('categories', models.ManyToManyField(related_name='agenda_event_related', verbose_name='Categories', to='agenda.Category', blank=True)),
                ...
                ('picture', models.ForeignKey(related_name='agenda_event_events', verbose_name='Picture', blank=True, to='media.Image', null=True)),
            ],
            options={
                'ordering': ['start_time'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='event',
            name='venue',
            field=models.ForeignKey(verbose_name='Venue', to='agenda.Venue'),
        ),
    ]
